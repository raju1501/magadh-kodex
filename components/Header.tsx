    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-6 py-4">
        ...
        <nav className="hidden md:flex items-center gap-8 text-slate-700 font-medium">
          ...
          <Link href="/services" className="hover:text-yellow-500 transition">Solutions</Link>
        ...
        <div className="hidden md:block">
          <button className="bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-2.5 rounded-md font-medium transition">
            Get a Quote
          </button>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-white border-t">
          <nav className="flex flex-col px-6 py-4 gap-4 text-slate-700 font-medium">
            ...
            <button className="mt-4 bg-yellow-500 hover:bg-yellow-600 text-white py-2 rounded-md">
              Get a Quote
            </button>
          </nav>
        </div>
